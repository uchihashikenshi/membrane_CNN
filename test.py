# coding:utf-8
from utils import Preprocessing_python2

p = Preprocessing_python2()
...
p.patch_extract("preprocessed/training/pooled_training_dataset", "raw/train-labels", "separated_equal_")
